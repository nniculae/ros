...
#[ApiResource(
    ...
    operations: [
        ...
        new Patch(
            input: UserUpdatePasswordDto::class,
            processor: UserUpdatePasswordProcessor::class,
            uriTemplate: '/users/update_password/{id}.{_format}',
...
#[UniqueEntity(
    fields: 'email',
    message: 'The email address {{ value }} already exists in our system.',
)]
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Groups(['user:read', 'user:write', 'address:item:get'])]
    #[Assert\NotBlank]
    #[Assert\Email]
    ...
    #[UserAssert\Roles(['ROLE_ADMIN', 'ROLE_USER'])]
    private array $roles = [];
